...
DOWNLOAD_URL = 'https://github.com/Bis-Buns/plugin-distrib/raw/{branch}/plugins/{plugin_name}/latest.zip'
ICON_URL = 'https://raw.githubusercontent.com/Bis-Buns/plugin-distrib/{branch}/icons/{plugin_name}.png'
